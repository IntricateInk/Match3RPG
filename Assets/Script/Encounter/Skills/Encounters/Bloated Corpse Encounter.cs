...
namespace Match3.Encounter.Effect.Passive
{
    public partial class CharacterPassive : ITooltip
    {
        ...
        public static CharacterPassive WATER_ZOMBIE_1 = WaterZombies("Bloated Corpses", "icons/undead_1", 1, 1, 2);
        public static CharacterPassive WATER_ZOMBIE_2 = WaterZombies("Drowned Dead", "icons/undead_1", 1, 3, 4);
    }
}